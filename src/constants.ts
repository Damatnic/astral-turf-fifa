...
import type { PlayerRole, Player, PlayerContract, TrainingDrill, PlaybookItem, TrainingPlanTemplate, User, RootState, Formation } from './types';
import type { PlayerInstruction, PositionRole, TeamKit, TeamTactics, Season, LeagueTeam, LeagueTableEntry, Fixture, WeeklySchedule, PlayerAttributes, DailySchedule } from './types';
...
export const DEMO_USERS: User[] = [
    ...
    // New Family Members
    {
      ...
      lastName: 'Smith',
      playerIds: ['player1'],
      notifications: { ...defaultNotifications, trainingReminders: false },
      timezone: 'America/New_York',
      language: 'en',
    ...
    {
      id: 'family2',
      email: 'sarah.carter@astralfc.com',
      role: 'family',
      firstName: 'Sarah',
      lastName: 'Carter',
      playerIds: ['player2'],
    ...
    },
    {
      ...
      lastName: 'Garcia',
      playerIds: ['player3'],
      notifications: { ...defaultNotifications, sms: true },
      timezone: 'America/New_York',
      language: 'es',
