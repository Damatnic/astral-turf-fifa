...
const StadiumPage: React.FC = () => {
    ...
    const getFacilityDescription = (level: number, type: 'training' | 'youth') => {
        if (type === 'training') {
            switch (level) {
                case 1: return 'Basic training grounds with minimal equipment';
                case 2: return 'Standard facilities with decent equipment and medical room';
                case 3: return 'Good facilities with modern equipment and recovery areas';
                case 4: return 'Excellent facilities with state-of-the-art equipment';
                case 5: return 'World-class training complex with cutting-edge technology';
                default: return 'No training facilities';
            }
        } else {
            switch (level) {
                case 1: return 'Basic youth setup with limited coaching staff';
                case 2: return 'Standard youth facilities with qualified coaches';
                case 3: return 'Good youth academy with specialized programs';
                case 4: return 'Excellent youth system producing quality prospects';
                case 5: return 'Elite academy known for developing world-class talent';
                default: return 'No youth facilities';
            }
        }
    };
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-gray-800 rounded-lg p-6 mb-8 border border-gray-700">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-xl font-bold text-white">Level {stadium.trainingFacilitiesLevel}</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-2xl font-bold text-white">Level {stadium.trainingFacilitiesLevel}</span>
                        </div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="space-y-1">
                                {getFacilityBenefits(stadium.trainingFacilitiesLevel, 'training').map((benefit, index) => (
                        ...
                        {stadium.trainingFacilitiesLevel < 5 ? (
                            <div className="border-t border-gray-700 pt-4">
                                <div className="flex items-center justify-between mb-3">
                                    <div>
                                        <p className="text-white font-medium">Upgrade to Level {stadium.trainingFacilitiesLevel + 1}</p>
                                    ...
                                    <button
                                        ...
                                        disabled={finances.transferBudget < getUpgradeCost(stadium.trainingFacilitiesLevel)}
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="text-2xl font-bold text-white">Level {stadium.youthFacilitiesLevel}</span>
                        </div>
                        ...
                        <div className="mb-6">
                            <h4 className="text-sm font-semibold text-gray-300 mb-2">Current Benefits:</h4>
                            <div className="space-y-1">
                                {getFacilityBenefits(stadium.youthFacilitiesLevel, 'youth').map((benefit, index) => (
                        ...
                        {stadium.youthFacilitiesLevel < 5 ? (
                            <div className="border-t border-gray-700 pt-4">
                                <div className="flex items-center justify-between mb-3">
                                    <div>
                                        <p className="text-white font-medium">Upgrade to Level {stadium.youthFacilitiesLevel + 1}</p>
                                        <p className="text-yellow-400 font-bold">
                                    ...
                                    <button
                                        ...
                                        disabled={finances.transferBudget < getUpgradeCost(stadium.youthFacilitiesLevel)}
                                        className={`px-4 py-2 rounded-md font-medium transition-colors ${
                ...
                <div className="mt-8 bg-gray-800 rounded-lg p-6 border border-gray-700">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="text-center">
                            <p className="text-3xl font-bold text-blue-400">{stadium.capacity.toLocaleString()}</p>
                        ...
                        <div className="text-center">
                            <p className="text-3xl font-bold text-purple-400">
                                ${((getUpgradeCost(stadium.trainingFacilitiesLevel) + getUpgradeCost(stadium.youthFacilitiesLevel)) / 1000).toFixed(0)}k
                            </p>
