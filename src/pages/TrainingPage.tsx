            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="px-3 py-1 rounded-md text-sm bg-purple-600 hover:bg-purple-700 text-white transition-colors"
                >
                  AI Optimize
                </button>
                <button
                  onClick={handleSimulateTraining}
                  className="px-3 py-1 rounded-md text-sm bg-blue-600 hover:bg-blue-700 text-white transition-colors"
                >
                  Simulate
                </button>
                <button
              ...
              >
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 px-2 py-1 bg-purple-600 hover:bg-purple-700 text-white rounded text-xs transition-colors"
                  >
                    AI Plan
                  </button>
                  <button className="flex-1 px-2 py-1 bg-teal-600 hover:bg-teal-700 text-white rounded text-xs transition-colors">
                    View Profile
                  </button>
                </div>
