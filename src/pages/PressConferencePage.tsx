                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className={`font-bold ${
                                        jobSecurity >= 70 ? 'text-green-400' :
                                        jobSecurity >= 40 ? 'text-yellow-400' : 'text-red-400'
                                    }`}>
                                        {jobSecurity}%
                                    </span>
                                </div>
                        ...
                        <div className="text-center">
                            <div className="mb-4">
                                <div className={`text-3xl font-bold ${
                                    fanConfidence >= 70 ? 'text-green-400' :
                                    fanConfidence >= 40 ? 'text-yellow-400' : 'text-red-400'
                                }`}>
                                    {fanConfidence}%
                                </div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-500 text-sm">
                                {38 - gameWeek} weeks remaining in season
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                            ...
                            {getRecentNarratives().length > 0 ? (
                                    ...
                                    {getRecentNarratives().map((narrative) => (
                                        <div
                                            ...
                                            className={`p-4 rounded-lg border-l-4 ${getNarrativeToneBackground(narrative.tone)} ${
                                                narrative.tone === 'positive' ? 'border-l-green-400' :
                                                narrative.tone === 'negative' ? 'border-l-red-400' :
                                                'border-l-gray-400'
                                            }`}
                                        >
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                                                        narrative.tone === 'positive' ? 'bg-green-600/20 text-green-400' :
                                                        narrative.tone === 'negative' ? 'bg-red-600/20 text-red-400' :
                                                        'bg-gray-600/20 text-gray-400'
                                                    }`}>
                                                        {narrative.tone}
                                                    </span>
                                                    <span className="text-xs text-gray-500">Week {narrative.weekGenerated}</span>
                                                </div>
                                            </div>
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-500">Media narratives will appear here based on your press conference responses</p>
                                </div>
                            )}
                        </div>
                    </>
                                        ...
                                        <div className="flex-grow">
                                            ...
                                            <div className="flex space-x-4 text-xs">
                                                <div className={`flex items-center space-x-1 ${
                                                    option.fanConfidenceEffect > 0 ? 'text-green-400' :
                                                    option.fanConfidenceEffect < 0 ? 'text-red-400' : 'text-gray-400'
                                                }`}>
                                                    <span>Fan Confidence:</span>
                                                    <span>{option.fanConfidenceEffect > 0 ? '+' : ''}{option.fanConfidenceEffect}</span>
                                                </div>
                                                <div className={`flex items-center space-x-1 ${
                                                    option.teamMoraleEffect > 0 ? 'text-green-400' :
                                                    option.teamMoraleEffect < 0 ? 'text-red-400' : 'text-gray-400'
                                                }`}>
                                                    <span>Team Morale:</span>
                                                    <span>{option.teamMoraleEffect > 0 ? '+' : ''}{option.teamMoraleEffect}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
