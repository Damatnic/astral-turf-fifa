                                ...
                                .map((team, index) => (
                                    ...
                                    >
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span className={`font-medium ${team.isUserTeam ? 'text-teal-400' : 'text-white'}`}>
                                                {team.teamName}
                                            </span>
                                        </div>
                    ...
                    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
                        ...
                        <div className="space-y-3">
                            {franchiseState.boardObjectives.slice(0, 4).map((objective) => (
                                <div key={objective.id} className="flex items-center justify-between p-3 bg-gray-700 rounded">
                                    <div className="flex items-center space-x-3">
