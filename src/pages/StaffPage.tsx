    ...
    const handleHireStaff = (staffMember: any, type: keyof typeof availableStaff) => {
        ...
        if (finances.transferBudget >= staffCost) {
            const staffType = type === 'coaches' ? 'coach' :
                            type === 'scouts' ? 'scout' :
                            type === 'medical' ? 'medicine' :
                            type === 'assistants' ? 'assistantManager' :
                            type === 'gkCoaches' ? 'gkCoach' :
                            type === 'fitnessCoaches' ? 'fitnessCoach' :
                            'loanManager';
                ...
                <div>
                    <div className="flex justify-between items-start mb-3">
                        <div>
                            ...
                            <p className="text-sm text-gray-400">Weekly Cost: ${staffMember.cost.toLocaleString()}</p>
                        </div>
                    </div>
                    {children}
                </div>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                {activeTab === 'current' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <StaffCard
                            title="Head Coach"
                            staffMember={staff.coach}
                            emptyText="No head coach hired"
                        >
                        ...
                        <StaffCard
                            title="Head Scout"
                            staffMember={staff.scout}
                            emptyText="No head scout hired"
                        >
                            <div className="space-y-2">
                                <div className="flex justify-between">
                                    ...
                                    <div key={coach.id} className="bg-gray-800 rounded-lg p-4 border border-gray-700">
                                        <div className="flex justify-between items-start mb-3">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-400 capitalize">Specialty: {coach.specialty}</p>
                                            </div>
