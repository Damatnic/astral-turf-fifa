    ...
    return (
        <div className="w-full h-full p-6 bg-gray-900 overflow-y-auto">
            <div className="max-w-6xl mx-auto">
                ...
                {/* Main Status */}
                <div className={`rounded-lg p-8 mb-8 border-2 ${security.bg} ${security.color.replace('text-', 'border-')}`}>
                    <div className="text-center">
                        ...
                        <p className="text-gray-300 text-lg">
                            {security.level === 'Excellent' && 'The board has complete confidence in your abilities.'}
                            ...
                            {fanConfidence >= 60 && (
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400 text-sm">
                                            Fan confidence at {fanConfidence}%
                                        </p>
                                    </div>
                                </div>
                            )}
