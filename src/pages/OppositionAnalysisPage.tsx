...
const OppositionAnalysisPage: React.FC = () => {
    ...
    const getStatusBackground = (status: string) => {
        switch (status) {
            ...
            case 'overdue': return 'bg-red-600/20';
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`p-4 rounded-lg border-l-4 ${getStatusBackground(status)} ${
                                                ...
                                                status === 'overdue' ? 'border-l-red-400' :
                                                'border-l-yellow-400'
                                            }`}
                                        >
                                            <div className="flex items-start justify-between mb-2">
                                                ...
                                                <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                                                    ...
                                                    status === 'overdue' ? 'bg-red-600/20 text-red-400' :
                                            ...
                                            {assignment.report ? (
                                                <div className="mt-3 p-3 bg-gray-700 rounded">
                                                    ...
                                                    <div className="space-y-2 text-sm text-gray-300">
                                                        <div>
                                                            <span className="font-medium">Key Players:</span> {assignment.report.keyPlayers}
                                                        </div>
                                                        <div>
                                                            <span className="font-medium">Tactical Approach:</span> {assignment.report.tacticalApproach}
                                                        </div>
                                                        <div>
                                                            <span className="font-medium">Weaknesses:</span> {assignment.report.weaknesses}
                                                        </div>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div className="mt-3 p-3 bg-gray-700 rounded">
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <span className="text-sm text-yellow-400">Scout analyzing opponent...</span>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
