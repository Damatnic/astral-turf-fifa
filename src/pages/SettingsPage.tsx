...
import { ResponsiveGrid } from '../components/Layout/AdaptiveLayout.tsx';
...
const SettingsPage: React.FC = () => {
  ...
  return (
    <ResponsivePage title="Settings" maxWidth="xl">
      <p className="text-gray-400 mb-6">Customize your Astral Turf experience</p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Show/hide grid lines on the tactical field</p>
              </div>
              <button
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-medium text-gray-200">Formation Strength Indicators</h3>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <div className="text-xs text-gray-400 mt-1">Players align to grid positions</div>
                </button>
                <button
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400">Reset all data and return to initial state</p>
              </div>
              <button
