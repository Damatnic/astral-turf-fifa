...
const BoardObjectivesPage: React.FC = () => {
    ...
    const getObjectiveIcon = (objective: BoardObjective) => {
        ...
        if (objective.description.toLowerCase().includes('final') || objective.description.toLowerCase().includes('cup')) {
            return (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        if (objective.description.toLowerCase().includes('finance') || objective.description.toLowerCase().includes('profit')) {
            return (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        if (objective.description.toLowerCase().includes('youth') || objective.description.toLowerCase().includes('develop')) {
            return (
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="w-full h-full p-6 bg-gray-900 overflow-y-auto">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <div className={`rounded-lg p-6 border-2 ${jobSecurityStatus.bg} ${jobSecurityStatus.color.replace('text-', 'border-')}`}>
                        <div className="flex items-center justify-between">
                            ...
                            <div className={jobSecurityStatus.color}>
                                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.5 0a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z" />
                                </svg>
                            </div>
                        </div>
                    </div>
