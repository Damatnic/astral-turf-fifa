...
export const Doughnut = React.forwardRef<any, any>((props, ref) => 
  React.createElement(MockChart, { ...props, type: 'doughnut', ref })
);
Doughnut.displayName = 'Doughnut';

export const Radar = React.forwardRef<any, any>((props, ref) => 
...
export const PolarArea = React.forwardRef<any, any>((props, ref) => 
  React.createElement(MockChart, { ...props, type: 'polarArea', ref })
);
PolarArea.displayName = 'PolarArea';

export const Scatter = React.forwardRef<any, any>((props, ref) => 
  React.createElement(MockChart, { ...props, type: 'scatter', ref })
);
Scatter.displayName = 'Scatter';

export const Bubble = React.forwardRef<any, any>((props, ref) => 
