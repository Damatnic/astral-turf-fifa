...
export type Action =
  ...
  | { type: 'UPDATE_USER_PROFILE'; payload: Partial<any> } // Partial<User>
  | { type: 'ADD_FAMILY_ASSOCIATION'; payload: any } // FamilyMemberAssociation
  | { type: 'UPDATE_FAMILY_ASSOCIATION'; payload: any } // FamilyMemberAssociation
  | { type: 'REMOVE_FAMILY_ASSOCIATION'; payload: string }
  | { type: 'LOAD_FAMILY_ASSOCIATIONS'; payload: any[] } // FamilyMemberAssociation[]
  | { type: 'UPDATE_NOTIFICATION_SETTINGS'; payload: Partial<any> } // Partial<NotificationSettings>
