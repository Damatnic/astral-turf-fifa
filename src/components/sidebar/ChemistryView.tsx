        ...
        <div className="p-2 space-y-4">
            <div>
                ...
                <div className="space-y-1">
                    {top5.map((pair, i) => (
                        <div key={i} className="flex items-center justify-between text-sm p-1 bg-gray-700/50 rounded">
                            <div className="flex items-center truncate">
                                <RelationshipIcon type={pair.relationship || undefined} />
                                <span className="ml-1.5 truncate" title={`${pair.p1} & ${pair.p2}`}>{pair.p1} & {pair.p2}</span>
                            </div>
