...
const DugoutManagement: React.FC<DugoutManagementProps> = ({
  ...
  const [substitutionFilter, setSubstitutionFilter] = useState<'all' | 'urgent' | 'suggested'>('all');
  ...
  const tacticalAdjustments = useMemo((): TacticalAdjustment[] => [
    {
      id: 'press_high',
      type: 'pressing',
  ...
  const tabs = [
    { id: 'substitutions', name: 'Substitutions', icon: ArrowUpDown, count: filteredCandidates.length },
        ...
        <div className="flex-1 overflow-hidden">
          <AnimatePresence mode="wait">
                    ...
                    {filteredCandidates.map(candidate => {
                      ...
                      return (
                        <motion.div
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={() => setSelectedPlayerOut(
                            isSelected ? null : candidate.player.id
                          )}
                          className={`
            ...
            {activeTab === 'adjustments' && (
              ...
              >
                <h3 className="text-lg font-semibold text-white mb-6">Recommended Tactical Adjustments</h3>
            ...
            {activeTab === 'instructions' && (
              <motion.div
                ...
                className="h-full p-6"
              >
                <h3 className="text-lg font-semibold text-white mb-6">Individual Player Instructions</h3>
                  ...
                  {fieldPlayers.map(player => (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        {['Stay wide', 'Get forward', 'Sit narrow', 'Play deeper'].map(instruction => (
                          <button
                            key={instruction}
            ...
            {activeTab === 'analytics' && (
              ...
              >
                <div className="text-center text-slate-400">
                  ...
                  <p className="text-sm">Real-time performance data and insights will appear here during matches.</p>
                </div>
              </motion.div>
            )}
          </AnimatePresence>
