...
const MenuItem: React.FC<{ to: string; children: React.ReactNode; onClick: () => void }> = ({
  to,
  children,
  onClick,
}) => (
    ...
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-64 bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-md shadow-lg z-20">
          ...
          <MenuItem to="/inbox" onClick={closeMenu}>
            <NewspaperIcon className="w-4 h-4 mr-2" />
            Inbox
          </MenuItem>
          <MenuItem to="/press-conference" onClick={closeMenu}>
          ...
          <MenuItem to="/board-objectives" onClick={closeMenu}>
            <TargetIcon className="w-4 h-4 mr-2" />
            Board Objectives
          </MenuItem>
          <MenuItem to="/job-security" onClick={closeMenu}>
          ...
          <MenuItem to="/transfers" onClick={closeMenu}>
          ...
          <MenuItem to="/training" onClick={closeMenu}>
            <UsersIcon className="w-4 h-4 mr-2" />
            Training
          </MenuItem>
          <MenuItem to="/mentoring" onClick={closeMenu}>
            <UsersIcon className="w-4 h-4 mr-2" />
            Mentoring
          </MenuItem>
          <MenuItem to="/youth-academy" onClick={closeMenu}>
            <GraduationCap className="w-4 h-4 mr-2" />
            Youth Academy
          </MenuItem>
          <MenuItem to="/skill-challenges" onClick={closeMenu}>
            <AwardIcon className="w-4 h-4 mr-2" />
            Skill Challenges
          </MenuItem>
          <MenuItem to="/player-ranking" onClick={closeMenu}>
            <SparklesIcon className="w-4 h-4 mr-2" />
            My Player Ranking
          </MenuItem>
          <MenuItem to="/challenge-hub" onClick={closeMenu}>
            <AwardIcon className="w-4 h-4 mr-2" />
            Challenge Hub
          </MenuItem>
          <MenuItem to="/challenge-manager" onClick={closeMenu}>
            <Briefcase className="w-4 h-4 mr-2" />
            Challenge Manager
          </MenuItem>
          <MenuItem to="/medical-center" onClick={closeMenu}>
          ...
          <MenuItem to="/analytics" onClick={closeMenu}>
