  ...
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-slate-800/70  border border-slate-600/50 rounded-lg shadow-2xl flex items-center p-2 space-x-2 z-20">
      ...
      <div className="flex items-center space-x-1">
        ...
        <ToolButton
          label="Toggle Formation Strength"
        ...
        <div className="relative w-8 h-8 flex items-center justify-center">
          ...
          <div
            ...
            className="w-6 h-6 rounded-md border-2 border-slate-500 pointer-events-none"
          ></div>
        </div>
      </div>
      ...
      <div className="flex items-center space-x-1">
        {isAnimating ? (
          <button
            ...
            onClick={handleReset}
            className="p-2 rounded-md text-white bg-red-600 hover:bg-red-500 transition-colors"
          >
          ...
          <button
            ...
            className="p-2 rounded-md text-gray-300 hover:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed disabled:hover:bg-transparent transition-colors"
          >
      ...
      <div className="flex items-center space-x-1">
        <button
          ...
          className="p-2 rounded-md text-gray-300 hover:bg-gray-700 disabled:text-gray-500 disabled:cursor-not-allowed disabled:hover:bg-transparent"
        >
