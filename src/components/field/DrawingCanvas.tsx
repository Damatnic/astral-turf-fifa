        ...
        >
            <defs>
              {uniqueColors.map(color => {
                ...
                return (
                  <marker key={`arrowhead-${safeColor.replace('#','')}`} id={`arrowhead-${safeColor.replace('#','')}`} viewBox="0 0 10 10" refX="8" refY="5" markerWidth="4" markerHeight="4" orient="auto-start-reverse">
