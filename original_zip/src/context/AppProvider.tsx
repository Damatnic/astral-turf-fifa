...
import type { RootState, Action, TacticsState, FranchiseState, UIState, AuthState } from '../types';
    ...
    try {
      ...
      if (savedStateJSON) {
        ...
        if (savedState.version === APP_VERSION) {
          ...
          console.warn(
            `Saved state version (${savedState.version}) does not match app version (${APP_VERSION}). Discarding saved state.`,
          );
