...
export const uiReducer = (draft: UIState, action: Action): UIState | void => {
  switch (action.type) {
    ...
    case 'RESET_ANIMATION':
      ...
      break;
    case 'GENERATE_AI_INSIGHT_START':
      draft.isLoadingAI = true;
      draft.aiInsight = null;
      break;
    ...
    case 'GENERATE_AI_COMPARISON_START':
      draft.isComparingAI = true;
      draft.aiComparisonResult = null;
      break;
    ...
    case 'SUGGEST_FORMATION_START':
      draft.isSuggestingFormation = true;
      draft.aiSuggestedFormation = null;
      break;
    ...
    case 'START_TUTORIAL':
      draft.tutorial.isActive = true;
      draft.tutorial.step = 0;
      break;
    case 'END_TUTORIAL':
    ...
    case 'GET_AI_DEVELOPMENT_SUMMARY_START':
      draft.isLoadingDevelopmentSummary = true;
      draft.developmentSummary = null;
      break;
    ...
    case 'GET_TEAM_TALK_OPTIONS_START':
      draft.isLoadingTeamTalk = true;
      draft.teamTalkData = null;
      break;
