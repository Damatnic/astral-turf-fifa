...
registry.register('ai.analyze', {
  ...
  method: 'POST',
  description: 'Generate AI-powered tactical analysis and insights for current formation and team setup',
  parameters: [
    {
  ...
  responseSchema: z.object({
    ...
    data: z.object({
      ...
      tacticalAdjustments: z.array(z.object({
        type: z.string(),
        description: z.string(),
          ...
          insights: [
            {
              ...
              description: 'Your wide forwards create significant attacking threat with pace and dribbling ability',
              confidence: 0.92,
              actionable: true,
