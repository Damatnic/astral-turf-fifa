...
import { Player, PlaybookEvent } from '../../types';
...
const EventDisplay: React.FC<{event: PlaybookEvent}> = ({ event }) => {
    ...
    return (
        <div className="flex items-center text-sm">
            ...
            <span className="text-gray-300 ml-1.5 truncate" title={event.description}>{event.description}</span>
        </div>
    );
}
...
const PresentationControls: React.FC = () => {
    ...
    const totalSteps = activeItem.steps.length;
